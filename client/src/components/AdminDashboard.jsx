                        ...
                        {meets.map(meet => (
                            ...
                            >
                                ...
                                <div className="flex flex-col gap-2 mt-3">
                                    ...
                                    {meet.admin_pin && (
                                        <div className="flex justify-between items-center bg-navy-900 border border-white/5 rounded p-2">
                                            <span className="text-xs text-slate-500 uppercase font-bold">Staff / Admin PIN</span>
                                                ...
                                                <tr key={res.id} className={`transition-colors ${res.is_dq ? 'bg-red-900/20' : 'hover:bg-white/5'}`}>
                                                    ...
                                                    <td className="py-2 text-right">
                                                        {isEditing ? (
                                                            ...
                                                            <button onClick={() => handleEditClick(res)} className="text-slate-500 hover:text-cyan-400 opacity-50 group-hover:opacity-100 transition-opacity">
